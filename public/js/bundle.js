...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js","./login":"login.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var loninForm = document.querySelector('.form--login');
var logoutBtn = document.querySelector('.nav__el--logout');
var settingForm = document.querySelector('.form-user-data');
var passwordChangeForm = document.querySelector('.form-user-settings');
var list = document.querySelectorAll('li');

if (loninForm) {
  loninForm.addEventListener('submit', function (e) {
    e.preventDefault();
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return (0, _update.updateSetting)({
